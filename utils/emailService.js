        ...
        <div style="max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.1); border: 1px solid #e1e8ed;">
            ...
            <div style="padding: 40px; color: #334155; line-height: 1.6;">
                ...
                <div style="margin-top: 30px; text-align: center;">
                    <a href="https://princyshahconsulting.in/" style="background: ${PRIMARY_COLOR}; color: white; padding: 15px 30px; border-radius: 10px; text-decoration: none; font-weight: bold; display: inline-block; box-shadow: 0 10px 20px rgba(0,95,184,0.3);">Visit Our Website</a>
                </div>
            </div>
